...
def model_setup(num_classes=102, pretrained_network='resnet50', learning_rate=0.001, hidden_units=None):
    ...
    checkpoint_data = {'arch': pretrained_network,
...
def save_checkpoint(model, class_to_idx, checkpoint_data, filepath='resnet50_model.pth'):
    """
    ...
    checkpoint_data['class_to_idx'] = class_to_idx
