...
def model_setup(pretrained_network='resnet50', learing_rate=0.001, num_classes=102, hidden_units=1024):
    """
...
def train(model, trainloader, validationloader, criterion, optimizer, epochs=5, gpu='True'):
    """
    ...
    Args:
        ...
        gpu: Indicates the desired device to use for model/network training + eval [Default: 'True']
...
def test_model_accuracy(model, data_loader=testloader, gpu='True'):
    """
