...
def parse_args():
    ...
    add_arg('--top_k', type=int, default=1, help='Number of Top K predicted classes to return. Default=1')
...
def main():
    ...
    try:
        ...
        print(f"I'm sorry but {args.checkpoint} is not a valid model checkpoint filepath.")
        return
